...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    public class PurchaseOrderController : ControllerBase
    {
        ...
        private readonly IPurchaseOrderBO _bo;

        public PurchaseOrderController(IUtilityLogger logger, IPurchaseOrderBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(PurchaseOrderDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<PurchaseOrderDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(PurchaseOrderDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<PurchaseOrderDM> inc)
        {
            try
            {
