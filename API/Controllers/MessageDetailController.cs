...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    public class MessageDetailController : ControllerBase
    {
        ...
        private readonly IMessageDetailBO _bo;

        public MessageDetailController(IUtilityLogger logger, IMessageDetailBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(MessageDetailDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<MessageDetailDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(MessageDetailDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<MessageDetailDM> inc)
        {
            try
            {
