...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    public class DetailController : ControllerBase
    {
        ...
        private readonly IDetailBO _bo;

        public DetailController(IUtilityLogger logger, IDetailBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(DetailDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<DetailDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(DetailDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<DetailDM> inc)
        {
            try
            {
