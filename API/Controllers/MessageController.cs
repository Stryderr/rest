...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    public class MessageController : ControllerBase
    {
        ...
        private readonly IMessageBO _bo;

        public MessageController(IUtilityLogger logger, IMessageBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(MessageDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<MessageDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(MessageDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<MessageDM> inc)
        {
            try
            {
