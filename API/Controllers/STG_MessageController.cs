...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    [ApiController]
    public class STG_MessageController : ControllerBase
    {
        private readonly IUtilityLogger _logger;
        private readonly ISTG_MessageBO _bo;

        public STG_MessageController(IUtilityLogger logger, ISTG_MessageBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(STG_MessageDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<STG_MessageDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(STG_MessageDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<STG_MessageDM> inc)
        {
            try
            {
