...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    [ApiController]
    public class STG_PurchaseOrderController : ControllerBase
    {
        private readonly IUtilityLogger _logger;
        private readonly ISTG_PurchaseOrderBO _bo;

        public STG_PurchaseOrderController(IUtilityLogger logger, ISTG_PurchaseOrderBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(STG_PurchaseOrderDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<STG_PurchaseOrderDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(STG_PurchaseOrderDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<STG_PurchaseOrderDM> inc)
        {
            try
            {
