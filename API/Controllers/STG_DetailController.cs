...
namespace WISR_PurchaseOrder_API.Controllers
{
    ...
    [ApiController]
    public class STG_DetailController : ControllerBase
    {
        private readonly IUtilityLogger _logger;
        private readonly ISTG_DetailBO _bo;

        public STG_DetailController(IUtilityLogger logger, ISTG_DetailBO bo)
        {
            _logger = logger;
            _bo = bo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Insert(STG_DetailDM inc)
        {
            try
            {
        ...
        [HttpPost]
        [Route("/batch")]
        public async Task<ActionResult> BatchInsert([FromBody] List<STG_DetailDM> inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("{id}")]
        public async Task<ActionResult> Update(STG_DetailDM inc)
        {
            try
            {
        ...
        [HttpPut]
        [Route("/batch")]
        public async Task<ActionResult> BatchUpdate([FromBody] List<STG_DetailDM> inc)
        {
            try
            {
