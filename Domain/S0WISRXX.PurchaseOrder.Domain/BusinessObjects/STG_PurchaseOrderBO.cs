...
namespace S0WISRXX.PurchaseOrder.Domain.BusinessObjects
{
    ...
    public class STG_PurchaseOrderBO : ISTG_PurchaseOrderBO
    {
        private readonly IUtilityLogger _logger;
        private readonly ISTG_PurchaseOrderRepository _repo;
        private readonly IMapper _mapper;

        public STG_PurchaseOrderBO(IUtilityLogger logger, ISTG_PurchaseOrderRepository repo)
        {
            _logger = logger;
            _repo = repo;
